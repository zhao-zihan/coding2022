...
### 1.1 面向过程与面向对象/Procedure Oriented Programming/Object Oriented Programming

![image-20220209233034294](images/image-20220209233034294.png)

![image-20220209233255802](images/image-20220209233255802.png)
...
![image-20220209234829574](images/image-20220209234829574.png)

![image-20220209234952506](images/image-20220209234952506.png)
...
![image-20220210170620950](images/image-20220210170620950.png)

![image-20220210170730427](images/image-20220210170730427.png)
...
<img src="images/image-20220210170852938.png" alt="image-20220210170852938" style="zoom:80%;" />
...
![image-20220210204135055](images/image-20220210204135055.png)
...
![image-20220210230009760](images/image-20220210230009760.png)
...
public class OverLoadTest {
	...
	public void getSum(int i,String s){//就算顺序不同也算重载
 ...
 * 	2.2 当调用可变个数形参的方法时，传入的参数的个数可以是：0个，1个，2个...，但都得是同一类型
...
![image-20220214005128008](images/image-20220214005128008.png)
...
![image-20220214005143562](images/image-20220214005143562.png)
...
![image-20220214220741366](images/image-20220214220741366.png)

##### 1.4.8 练习2

![image-20220214221109845](images/image-20220214221109845.png)
...
//正确写法1
for(int i = arr.length –1;i >= 0;i--){//从末尾除，不然第一位就变成一了，后面除以一都不变
	arr[i] = arr[i] / arr[0];
}
...
<img src="images/image-20220214222001201.png" alt="image-20220214222001201" style="zoom:80%;" />
...
![image-20220214234000191](images/image-20220214234000191.png)
...
![image-20220215000423282](images/image-20220215000423282.png)
...
<img src="images/image-20220215001410977.png" alt="image-20220215001410977" style="zoom: 67%;" />

##### 1.5.1 练习

<img src="images/image-20220215001733387.png" alt="image-20220215001733387" style="zoom:80%;" />
 ...
 * ① 默认初始化值
 * ② 显式初始化
 * ③ 构造器中初始化 前三个都为初始化，只执行一次，后面可多次赋值
...
<img src="images/image-20220215162511359.png" alt="image-20220215162511359" style="zoom:80%;" />
...
<img src="images/image-20220215165336698.png" alt="image-20220215165336698" style="zoom:80%;" />
 ...
 * 3.包，属于标识符，遵循标识符的命名规则、规范"见名知意" 包（xxxyyyzzz）
 * 4.每“.”一次,就代表一层文件目录。
 * 
...
<img src="images/image-20220217220859891.png" alt="image-20220217220859891" style="zoom:80%;" />

<img src="images/image-20220217220944512.png" alt="image-20220217220944512" style="zoom:80%;" />
