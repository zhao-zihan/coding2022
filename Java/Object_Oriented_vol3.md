...
![image-20220222211949288](images/image-20220222211949288.png)
...
#### 1.1.2 类变量 vs 实例变量内存解析

![image-20220222213817594](images/image-20220222213817594.png)
...
//		Bank bank2 = new Bank(); 
		...
		System.out.println(bank1 == bank2);//这两个其实是同一地址值，指向类内部的唯一对象
...
class Order{
	...
	public static Order getInstance(){
		...
		return instance;//要不是null，就直接返回对象，确保内存中只有独一份
	}
}
...
##### 1.1.7.4 单例(Singleton)设计模式-应用场景
...
public class MainDemo {
	public static void main(String[] args) {//默认获取到的都是string
...
public class BlockTest {
	public static void main(String[] args) {
		...
		System.out.println(desc);//这里会直接执行静态代码块
		
		Person p1 = new Person();//这里会执行非静态代码块
		Person p2 = new Person();//会再次执行非静态代码块
...
public class Son extends Father {
	...
	public static void main(String[] args) { // 由父及子 静态先行
		System.out.println("77777777777");//执行这句前会先执行静态方法，先出1111和4444
		System.out.println("************************");
		new Son();
...
#### 1.3.3 **总结：程序中成员变量赋值的执行顺序**

<img src="images/image-20220303143359646.png" alt="image-20220303143359646" style="zoom:80%;" />

```java
/*
 * 对属性可以赋值的位置:
 *  ①默认初始化
 *  ②显式初始化 / ⑤在代码块中赋值 谁先写就先执行谁
 *  ③构造器中初始化
 *  ④有了对象以后，可以通过"对象.属性"或"对象.方法"的方式，进行赋值。
 *  
 *  执行的先后顺序:① - ② / ⑤ - ③ - ④
...
![image-20220304130329143](images/image-20220304130329143.png)
...
#### 1.5.2 多态的应用：模板方法设计模式(TemplateMethod)

![image-20220304134055890](images/image-20220304134055890.png)
...
<img src="images/image-20220304172534349.png" alt="image-20220304172534349" style="zoom:80%;" />
...
![image-20220304175326066](images/image-20220304175326066.png)
...
#### 1.6.3 接口的应用：代理模式(Proxy)

![image-20220307214124539](images/image-20220307214124539.png)
...
![image-20220307220540922](images/image-20220307220540922.png)
...
![image-20220307220616802](images/image-20220307220616802.png)
...
![image-20220307220645288](images/image-20220307220645288.png)
...
![image-20220307222714405](images/image-20220307222714405.png)
